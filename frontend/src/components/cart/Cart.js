...
import { addItemToCart, decrementFrequency, incrementFrequency, removeItem } from "../redux/actions/cart-actions";
...
export default connect(mapStateToProps, { removeItem, incrementFrequency, decrementFrequency, addItemToCart })(CartBody);